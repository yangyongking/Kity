...
public class ScreenSwitch {
    ...
    private static final String TAG = ScreenSwitch.class.getSimpleName();

    private volatile static ScreenSwitch mInstance;
     ...
     **/
    public static ScreenSwitch init(Context context) {
        if (mInstance == null) {
            synchronized (ScreenSwitch.class) {
                if (mInstance == null) {
                    mInstance = new ScreenSwitch(context);
                }
            }
        }
        return mInstance;
    ...
    private ScreenSwitch(Context context) {
