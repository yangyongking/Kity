package me.windleafy.gity.android.view.textview;
...
public class MarqueeView extends ViewFlipper {
    ...
    @AnimRes
    private int inAnimResId = R.anim.gity_marquee_view_bottom_in;
    @AnimRes
    private int outAnimResId = R.anim.gity_marquee_view_top_out;
        ...
        if (hasSetDirection) {
            switch (direction) {
                case DIRECTION_BOTTOM_TO_TOP:
                    inAnimResId = R.anim.gity_marquee_view_bottom_in;
                    outAnimResId = R.anim.gity_marquee_view_top_out;
                    break;
                case DIRECTION_TOP_TO_BOTTOM:
                    inAnimResId = R.anim.gity_marquee_view_top_in;
                    outAnimResId = R.anim.gity_marquee_view_bottom_out;
                    break;
                case DIRECTION_RIGHT_TO_LEFT:
                    inAnimResId = R.anim.gity_marquee_view_right_in;
                    outAnimResId = R.anim.gity_marquee_view_left_out;
                    break;
                case DIRECTION_LEFT_TO_RIGHT:
                    inAnimResId = R.anim.gity_marquee_view_left_in;
                    outAnimResId = R.anim.gity_marquee_view_right_out;
                    break;
            }
        } else {
            inAnimResId = R.anim.gity_marquee_view_bottom_in;
    ...
    private void startWithFixedWidth(String notice, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        ...
        if (width == 0) {
            throw new RuntimeException("Please setCenter the width of MarqueeView !");
        }
